        ...
        return t.m = e, t.c = r, t.d = function (e, r, o) {
            ...
            var a = r(2), l = r(3), i = r(1), u = function (e) {
                ...
                return a.__extends(t, e), t.parse = function (e, t) {
                    ...
                    var o = this, n = this.buildUrl(), a = this.buildRequestParams(e, t, r), u = this.ajaxSettings || {}, c = u.success;
                    return a ? (this.calendar.pushLoading(), i.Promise.construct(function (e, t) {
                        l.ajax(l.extend({}, i.JsonFeedEventSource.AJAX_DEFAULTS, u, {url: n, data: a, success: function (r, n, u) {
                                var s, p;
                    ...
                    return r && t && (r = n(r, "ctz=" + t)), {id: e.id, title: e.summary, start: e.start.dateTime || e.start.date, end: e.end.dateTime || e.end.date, url: r, location: e.location, description: e.description}
                    ...
                    return n ? (e.hasZone() || (e = e.clone().utc().add(-1, "day")), t.hasZone() || (t = t.clone().utc().add(1, "day")), o = l.extend(this.ajaxSettings.data || {}, {key: n, timeMin: e.format(), timeMax: t.format(), singleEvents: !0, maxResults: 9999}), r && "local" !== r && (o.timeZone = r.replace(" ", "_")), o) : (this.reportError("Specify a googleCalendarApiKey. See http://fullcalendar.io/docs/google_calendar/"), null)
                    ...
                    var t = i.EventSource.prototype.applyManualStandardProps.apply(this, arguments), r = e.googleCalendarId;
