...
class PacienteModel {
    ...
    public function getExamesByPaciente($id) {
        return $this->database->selectManager("SELECT * FROM Exame INNER JOIN Paciente ON Exame.Paciente_id = Paciente.id WHERE Paciente.usuarios_id = $id ORDER BY id DESC ");
    }

    public function deletePaciente($id) {
        return $this->database->delete("Paciente", "id=$id");
    }
